class ConnectionService {
  ...
  static var notify = "$base_url/notification_fetch.php";
  static var marquee = "$base_url/notification_fetch.php";

  static var checkresult = "$base_url/notification_fetch.php";
}
